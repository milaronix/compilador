...
program:	(RESERVADA ID A_LLAVE (field_decl | method_decl)* C_LLAVE){System.out.println("program");};
field_decl:	(TYPE (ID | ID A_CORCHETE INT_LITERAL C_CORCHETE) ((ID | ID A_CORCHETE INT_LITERAL C_CORCHETE) COMA)* PYCOMA){System.out.println("field_decl");};
