...
public class DecafParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements DecafParserVisitor<T> {
	...
	@Override public T visitBlock_(DecafParser.Block_Context ctx) { return visitChildren(ctx); }
	...
	@Override public T visitBreak_o_continue(DecafParser.Break_o_continueContext ctx) { return visitChildren(ctx); }
