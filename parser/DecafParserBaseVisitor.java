...
public class DecafParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements DecafParserVisitor<T> {
	@Override public T visitLocation_(DecafParser.Location_Context ctx) { return visitChildren(ctx); }
	...
	@Override public T visitAd_ex(DecafParser.Ad_exContext ctx) { return visitChildren(ctx); }

	@Override public T visitStr_lit(DecafParser.Str_litContext ctx) { return visitChildren(ctx); }

	@Override public T visitBlock(DecafParser.BlockContext ctx) { return visitChildren(ctx); }

	@Override public T visitRe(DecafParser.ReContext ctx) { return visitChildren(ctx); }

	@Override public T visitRe_ap_ex_cp_blo(DecafParser.Re_ap_ex_cp_bloContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitRe_ac_ex_cc(DecafParser.Re_ac_ex_ccContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitBlo(DecafParser.BloContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitRe_id_ig_ex_co_ex_blo(DecafParser.Re_id_ig_ex_co_ex_bloContext ctx) { return visitChildren(ctx); }
